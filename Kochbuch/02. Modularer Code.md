...
3. Der Konstruktor der Eltern-Klasse sollte immer mit `this.callParent(arguments);` aufgerufen werden.  
Man könnte auch 
```javascript
...
```
> Beispiel: [Mixins](http://localhost:7777/Kapitel2/Mixins)
